...
Honest strongest claim: `Measure what language-conditioned policies fail to ground until touch resolves it.` is a plausible branch-structured mechanism for tactile-language-action models, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
