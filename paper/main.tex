...
\usepackage{url}
\usepackage{booktabs}
\title{Tactile-Language Grounding Debt: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about tactile-language-action models. The original research bet was: Measure what language-conditioned policies fail to ground until touch resolves it. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\begin{itemize}
\item LINGO-Space: Language-Conditioned Incremental Grounding for Space (2024)
\item Negative Object Presence Evaluation (NOPE) to Measure Object Hallucination in Vision-Language Models (2024)
\item SayNav: Grounding Large Language Models for Dynamic Planning to Navigation in New Environments (2024)
\item DRAGON: A Dialogue-Based Robot for Assistive Navigation with Visual Language Grounding (2023)
