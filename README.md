...
This repository contains a hardened, honest workshop-only robotics paper draft for `tactile_language_grounding_debt`.
...
Canonical local PDF path: `C:/Users/wangz/Downloads/81.pdf`
